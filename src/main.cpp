...
uint256 hashGenesisBlock("0xae07be6df4c72a1cb5aa64b951c0cc03ae1d124db565f9830852404634f96de6");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Nutcoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 302400; // Nutcoin: 3.5 days
static const int64 nTargetSpacing = 10; // Nutcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x696a13262a5b091feb4b550427a18f7bc395d6961ce08a60e0129f10d2e054be");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Big nut";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("44aac96e4ef028a94d3147e1b8aacf74e7723b40c8eca34abbfa88c37063e1456d2710e25c58af3a66bbf612d3a2069d781a4bc570f631d588d88763dd08fa025c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515310648;
        block.nBits    = 504365644;
        block.nNonce   = 289793167;

        if (fTestNet)
        {
            block.nTime    = 1515310648;
            block.nNonce   = 1957596134;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7a91fa24287b5c502a18e80f5004114579f1aa044c9a51a84f38803baa5182ee"));
        block.print();
